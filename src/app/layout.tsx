...
export const metadata: Metadata = {
  ...
  description: `${ABOUT_ME.name} — ${ABOUT_ME.title.en} portfolio showcasing projects and skills in React, Next.js, TypeScript, Node.js, and more. Based in ${ABOUT_ME.location.en}. Available for freelance and full-time opportunities.`,
  keywords: [
    ABOUT_ME.name,
    ABOUT_ME.title.en,
    ABOUT_ME.title.fr,
            ...
            __html: JSON.stringify([
              {
                ...
                name: ABOUT_ME.name,
                url: BASE_URL,
                jobTitle: ABOUT_ME.title.en,
                description: `${ABOUT_ME.name} is a ${ABOUT_ME.title.en} specializing in modern web applications built with Next.js and TypeScript.`,
